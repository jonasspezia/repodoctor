			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-4 text-center text-sm w-full">
						{$i18n.t(
							"Oops! You're using an unsupported method (frontend only). Please serve the DoctorAI from the backend."
						)}
						...
						>
						{$i18n.t('or')}
						<a class=" font-semibold underline" href="https://teledocmedical.com" target="_blank"
							>{$i18n.t('join our Teledoc for help.')}</a
						>
					</div>
